...
The gridlabd simulation is started by the [workflows file](.github/workflows/main.yml).  There are four important parts to this file
...
3. The [`#output`](main.glm#L5) macro is used to generate the voltage profile PNG image.  The file generated is used to provide the artifact saved by the [`save`](.github/workflows/main.yml#L31) step in the [workflows file](.github/workflows/main.yml).
